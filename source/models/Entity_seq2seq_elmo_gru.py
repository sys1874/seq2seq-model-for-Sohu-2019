...
from source.modules.encoders.rnn_encoder_elmo import RNNEncoder
...
from elmoformanylangs import Embedder  as elmo_Embedder
class Entity_Seq2Seq_elmo_gru(BaseModel):
    """
    Seq2Seq
    """
    def __init__(self,
        ...
        super(Entity_Seq2Seq_elmo_gru, self).__init__()
    ...
    def encode_infe(self,inputs, elmo_embed, hidden=None):
        ...
        enc_outputs, enc_hidden = self.encoder.infer(enc_inputs, elmo_embed, hidden)
    ...
    def encode(self, inputs, hidden=None):
        ...
        enc_inputs = inputs.num_src
        input_raw = inputs.raw_src
        enc_outputs, enc_hidden = self.encoder(enc_inputs, input_raw, hidden)
